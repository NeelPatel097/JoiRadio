...
import 'package:joiradio/model/radio.dart';
import 'package:joiradio/utils/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "ff7176d126ba172a3a7f8eddb6a272e52e956eca572e1d8b807a3e2338fdd0dc/stage",
      ...
      body: Stack(
        children: [
          VxAnimatedBox().size(context.screenWidth, context.screenHeight)
              ...
              .make(),
              [AppBar(
                title: "Joi Radio".text.xl4.bold.white.make().shimmer(
